...
mainWindow = tk.Tk()
mainWindow.title('University Management System | LOVELY PROFESSIONAL UNIVERSITY')

label_1 = tk.Label(mainWindow, text="\nLOVELY PROFESSIONAL UNIVERSITY STUDENT MANAGEMENT PORTAL  \n", font=("Georgia", 25),bg='orange',foreground="white")
